...
class Problem_3 {
    ...
    public static String printArray(Trade[] arr) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(printArray(trades));

        Trade[] mergeArr = trades.clone();
        mergeSort(mergeArr, 0, mergeArr.length - 1);
        System.out.println("MergeSort: " + printArray(mergeArr));

        Trade[] quickArr = trades.clone();
        quickSort(quickArr, 0, quickArr.length - 1);
        System.out.println("QuickSort (desc): " + printArray(quickArr));

        Trade[] merged = mergeLists(mergeArr, new Trade[0]);
